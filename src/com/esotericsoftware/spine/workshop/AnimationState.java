...
public class AnimationState {
	...
	AnimationState.Key tempKey = new Key();
	ObjectMap<AnimationState.Key, Float> animationToMixTime = new ObjectMap();
	...
	public void setMixing (Animation from, Animation to, float duration) {
		...
		AnimationState.Key key = new Key();
		key.a1 = from;
		key.a2 = to;
	...
	static class Key {
		...
		public boolean equals (Object obj) {
			...
			AnimationState.Key other = (AnimationState.Key)obj;
			if (a1 == null) {
